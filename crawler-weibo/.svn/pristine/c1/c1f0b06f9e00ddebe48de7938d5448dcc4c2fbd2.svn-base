...
public class TencentWeiboFromUserTimeLineHasNextPageRule extends WriterHasNextPageRule {
	...
	public boolean rule(WeiboPage weiboPage) {
		...
		log.info("TencentWeiboFromUserTimeLineHasNextPageRule 处理完成...." +sonWeiboPage);
