...
public class Work implements Runnable {
   ...
   */
  {
    ...
    ProcessorProxy sinaWeiboExtractorProxy = new ProcessorProxy(sinaWeiboExtractor);
    ...
    ProcessorProxy tencentWeiboExtractorProxy = new ProcessorProxy(tencentWeiboExtractor);
    ...
    ProcessorProxy twitterWeiboExtractorProxy = new ProcessorProxy(twitterWeiboExtractor);
    ...
    TencentWeiboFromUserTimeLineExtractor tencentWeiboFromUserTimeLineExtractor =
        new TencentWeiboFromUserTimeLineExtractor();
    ProcessorProxy tencentWeiboFromUserTimeLineExtractorProxy =
        new ProcessorProxy(tencentWeiboFromUserTimeLineExtractor);
    tencentWeiboFromUserTimeLineExtractorProxy.setTask(Task.Tencent);
    tencentWeiboFromUserTimeLineExtractorProxy.addBeforeRules(new DefaultBeforeRule());
    tencentWeiboFromUserTimeLineExtractorProxy.addAfterRules(new ExtractorOkRule());
    weiboUserTimeLineExtractorChain.addProcessor(tencentWeiboFromUserTimeLineExtractorProxy);

    SinaWeiboFromUserTimeLineExtractor sinaWeiboFromUserTimeLineExtractor =
        new SinaWeiboFromUserTimeLineExtractor();
    ProcessorProxy sinaWeiboFromUserTimeLineExtractorProxy =
        new ProcessorProxy(sinaWeiboFromUserTimeLineExtractor);
    sinaWeiboFromUserTimeLineExtractorProxy.setTask(Task.Sina);
    sinaWeiboFromUserTimeLineExtractorProxy.addBeforeRules(new DefaultBeforeRule());
    sinaWeiboFromUserTimeLineExtractorProxy.addAfterRules(new ExtractorOkRule());
    weiboUserTimeLineExtractorChain.addProcessor(sinaWeiboFromUserTimeLineExtractorProxy);

    SohuWeiboFromUserTimeLineExtractor sohuWeiboFromUserTimeLineExtractor =
        new SohuWeiboFromUserTimeLineExtractor();
    ProcessorProxy sohuWeiboFromUserTimeLineExtractorProxy =
        new ProcessorProxy(sohuWeiboFromUserTimeLineExtractor);
    sohuWeiboFromUserTimeLineExtractorProxy.setTask(Task.Sohu);
    sohuWeiboFromUserTimeLineExtractorProxy.addBeforeRules(new DefaultBeforeRule());
    sohuWeiboFromUserTimeLineExtractorProxy.addAfterRules(new ExtractorOkRule());
    weiboUserTimeLineExtractorChain.addProcessor(sohuWeiboFromUserTimeLineExtractorProxy);

    NeteaseWeiboFromUserTimeLineExtractor neteaseWeiboFromUserTimeLineExtractor =
        new NeteaseWeiboFromUserTimeLineExtractor();
    ProcessorProxy neteaseWeiboFromUserTimeLineExtractorProxy =
        new ProcessorProxy(neteaseWeiboFromUserTimeLineExtractor);
    neteaseWeiboFromUserTimeLineExtractorProxy.setTask(Task.Netease);
    neteaseWeiboFromUserTimeLineExtractorProxy.addBeforeRules(new DefaultBeforeRule());
    neteaseWeiboFromUserTimeLineExtractorProxy.addAfterRules(new ExtractorOkRule());
    weiboUserTimeLineExtractorChain.addProcessor(neteaseWeiboFromUserTimeLineExtractorProxy);

    TwitterWeiboFromUserTimelineExtractor twitterWeiboFromUserTimelineExtractor =
        new TwitterWeiboFromUserTimelineExtractor();
    ProcessorProxy twitterWeiboFromUserTimelineExtractorProxy =
        new ProcessorProxy(twitterWeiboFromUserTimelineExtractor);
    ...
    twitterWeiboFromUserTimelineExtractorProxy.addBeforeRules(new DefaultBeforeRule());
    twitterWeiboFromUserTimelineExtractorProxy.addAfterRules(new ExtractorOkRule());
    weiboUserTimeLineExtractorChain.addProcessor(twitterWeiboFromUserTimelineExtractorProxy);
    ...
    ProcessorProxy sinaFriendExtractorProxy = new ProcessorProxy(sinaFriendExtractor);
    ...
    ProcessorProxy tencentFriendExtractorProxy = new ProcessorProxy(tencentFriendExtractor);
    ...
    ProcessorProxy twitterFriendExtractorProxy = new ProcessorProxy(twitterFriendExtractor);
    ...
    ProcessorProxy neteastFriendExtractorProxy = new ProcessorProxy(neteastFriendExtractor);
    ...
    ProcessorProxy sohuFriendExtractorProxy = new ProcessorProxy(sohuFriendExtractor);
    ...
    ProcessorProxy sinaFollowerExtractorProxy = new ProcessorProxy(sinaFollowerExtractor);
    ...
    ProcessorProxy tencentFollowerExtractorProxy = new ProcessorProxy(tencentFollowerExtractor);
    ...
    ProcessorProxy twitterFollowerExtractorProxy = new ProcessorProxy(twitterFollowerExtractor);
    ...
    ProcessorProxy neteastFollowerExtractorProxy = new ProcessorProxy(neteastFollowerExtractor);
    ...
    ProcessorProxy sohuFollowerExtractorProxy = new ProcessorProxy(sohuFollowerExtractor);
    ...
    ProcessorProxy twitterUserShowExtractorProxy = new ProcessorProxy(twitterUserShowExtractor);
    ...
    ProcessorProxy neteastUserShowExtractorProxy = new ProcessorProxy(neteastUserShowExtractor);
    ...
    ProcessorProxy sohuUserShowExtractorProxy = new ProcessorProxy(sohuUserShowExtractor);
    ...
    ProcessorProxy twitterSearchExtractorProxy = new ProcessorProxy(twitterSearchExtractor);
    ...
    ProcessorProxy neteastSearchExtractorProxy = new ProcessorProxy(neteastSearchExtractor);
    ...
    ProcessorProxy twitterTrendExtractorProxy = new ProcessorProxy(twitterTrendExtractor);
    ...
    ProcessorProxy neteastTrendExtractorProxy = new ProcessorProxy(neteastTrendExtractor);
    ...
    extractorChain.addProcessor(weiboExtractorChain).addProcessor(weiboUserTimeLineExtractorChain)
        .addProcessor(friendExtractorChain).addProcessor(followerExtractorChain)
        .addProcessor(userShowExtractorChain).addProcessor(trendExtractorChain)
    ...
    TencentWeiboFromUserTimeLineHasNextPageRule tencentWeiboFromUserTimeLineHasNextPageRule =
        new TencentWeiboFromUserTimeLineHasNextPageRule();
    writerProxy.addAfterRules(tencentWeiboFromUserTimeLineHasNextPageRule);

    /*
     * TencentFriendHasNextPageRule tencentFriendHasNextPageRule = new TencentFriendHasNextPageRule();
     * writerProxy.addAfterRules(tencentFriendHasNextPageRule);
     */

    /*
     * TencentFollowerHasNextPageRule tencentFollowerHasNextPageRule = new TencentFollowerHasNextPageRule();
    ...
    SinaWeiboFromUserTimeLineHasNextPageRule sinaWeiboFromUserTimeLineHasNextPageRule =
        new SinaWeiboFromUserTimeLineHasNextPageRule();
    writerProxy.addAfterRules(sinaWeiboFromUserTimeLineHasNextPageRule);

    /*
     * SinaFriendHasNextPageRule sinaFriendHasNextPageRule = new SinaFriendHasNextPageRule();
     * writerProxy.addAfterRules(sinaFriendHasNextPageRule);
     */

    /*
     * SinaFollowerHasNextPageRule sinaFollowerHasNextPageRule = new SinaFollowerHasNextPageRule();
    ...
    TwitterFollowerHasNextPageRule twitterFollowerHasNextPageRule =
        new TwitterFollowerHasNextPageRule();
    ...
    NeteaseFollowerHasNextPageRule neteastFollowerHasNextPageRule =
        new NeteaseFollowerHasNextPageRule();
