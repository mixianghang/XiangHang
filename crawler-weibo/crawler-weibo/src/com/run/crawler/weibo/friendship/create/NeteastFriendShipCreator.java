...
public class NeteastFriendShipCreator  {
	private static final Logger log = Logger.getLogger(NeteastFriendShipCreator.class);
	/**
	 * 关注好友
	 * @param screen_name
	 */
	public static boolean createFriendShip(String screen_name) {
        ...
        String  queryStr = "screen_name=" + screen_name + "&" + NeteaseOauth.newInstance().getOauthUrl();
