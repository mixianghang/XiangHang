...
public class TwitterFriendShipCreator  {
	private static final Logger log = Logger.getLogger(TwitterFriendShipCreator.class);
	...
	public static boolean createFriendShip(String screen_name) {
        ...
        String  signature = TwitterOauth.newInstance().generateSignature(url, queryStr);
