...
public class SinaWeiboFromUserTimeLineHasNextPageRule extends WriterHasNextPageRule {
	...
	public boolean rule(WeiboPage weiboPage) {
		...
		if(query instanceof SinaWeiboFromUserTimeLineQuery){
			 ...
			 */
			sinaWeiboFromUserTimeLineQuery.setMax_id(Long.valueOf(oldMaxId) -1);
		}
		
		log.info("SinaWeiboFromUserTimeLineHasNextPageRule 处理完成..."+sonWeiboPage);
