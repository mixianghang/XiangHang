...
public class SinaFriendExtractor extends JsonExtractor {
	@Override
	public WeiboPage process(WeiboPage weiboPage) {
		...
		while (iterator.hasNext()) {
			...
			try {
				velocityBean.setAccount(URLDecoder.decode(
						weiboPage.getAccount(), "utf-8"));
		...
		log.info("SinaFriendExtractor 处理完成");
