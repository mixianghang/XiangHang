...
public class SohuFollowerExtractor extends JsonExtractor {
	...
	public WeiboPage process(WeiboPage weiboPage) {
		try {
			log.info("正在被SohuFollowerExtractor进行处理中...... ");
			JSONArray users = JSONArray.fromObject(weiboPage.getContent());
