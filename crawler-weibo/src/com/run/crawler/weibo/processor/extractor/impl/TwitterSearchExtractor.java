...
public class TwitterSearchExtractor extends JsonExtractor {
	...
	public WeiboPage process(WeiboPage weiboPage) {
		...
		try {
			log.info("正在被TwitterSearchExtractor进行处理中...... ");
			List<VelocityBean> beans = new ArrayList<VelocityBean>();
			JSONObject result = JSONObject.fromObject(weiboPage.getContent());
