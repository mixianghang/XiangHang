...
public class TestSinaOauth {
	...
	public static void main(String[] args) {
		...
		Oauth oauth = new Oauth("700115051",
				"44d36666703c47899d30101124ba2f1e",
				"http://apps.weibo.com/asfcasdvcasdvvdfv", "code", "", "");
		// list.add(new
		// Oauth("3942434916","1b67fecfc1347493563eec7856d078ec","http://weibo.com/jerry3g","code","",""));
